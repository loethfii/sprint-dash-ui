...
export default function ReportViewPage() {
  return (
    <DashboardShell activeTab="reports" title="Reports">
      {(isDarkMode) => (
        <div className={`flex-1 p-8 overflow-y-auto flex flex-col justify-center items-center text-center ${
          ...
          <div className="max-w-md space-y-4">
            <h2 className={`text-xl font-bold ${isDarkMode ? 'text-white' : 'text-slate-800'}`}>Reports & Analytics</h2>
            <p className="text-xs text-slate-500 leading-relaxed">
              This analytics view is queued for integration soon in your Sprint Dash workspace.
            </p>
            <a 
              href="/"
